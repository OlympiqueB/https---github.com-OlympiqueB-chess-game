...
export function noSelfCheck(targetRow, targetCol, currRow, currCol, color, board) { 
  ...
  playerPieces.forEach(t => attackedTilesClone(t.row, t.col, checkBoard).forEach(attT => attTiles.add(attT)));
